...
public class ApicurioRecordBasedSerializationFactoryImpl implements RecordBasedSerializationFactory {

    @Override
    public RecordBasedSerialization create() {
        return new ApicurioRecordBasedSerialization();
    }
}
