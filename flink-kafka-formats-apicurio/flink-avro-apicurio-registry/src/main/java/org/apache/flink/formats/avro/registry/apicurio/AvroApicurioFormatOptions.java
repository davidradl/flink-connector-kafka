...
public class AvroApicurioFormatOptions {
    ...
    public static final ConfigOption<Boolean> REGISTER_SCHEMA =
            ConfigOptions.key("register-schema")
                    ...
                    .defaultValue(false)
                    .withDescription(
                            "Whether a schema should be generated in the Apicurio Registry.");

    public static final ConfigOption<String> GROUP_ID =
            ConfigOptions.key("groupId")
                    .stringType()
                    .defaultValue("default")
                    .withDescription("ID of the Apicurio Group to use when the schema is registered or to be registered.");
    ...
    public static final ConfigOption<String> REGISTERED_ARTIFACT_ID =
            ConfigOptions.key("artifactId")
                    ...
                    .noDefaultValue()
                    .withDescription(
                            "ArtifactId is used by serializers when registering a new Schema to ensure that\n"
                                    + "each serialization is associated with the same schema in the registry.\n"
                                    + "It can be useful to include the topic name in the artifact id so\n"
                                    + "the schema can be identified with its associated topic.");
