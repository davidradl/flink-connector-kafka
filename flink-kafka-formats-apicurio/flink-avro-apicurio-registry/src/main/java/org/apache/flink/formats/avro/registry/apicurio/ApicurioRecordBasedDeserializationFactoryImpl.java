...
/**
 * Apicurio Record based Deserialization Factory implementation.
 */
public class ApicurioRecordBasedDeserializationFactoryImpl implements RecordBasedDeserializationFactory {

    @Override
    public RecordBasedDeserialization create() {
        return new ApicurioRecordBasedDeserialization();
    }
