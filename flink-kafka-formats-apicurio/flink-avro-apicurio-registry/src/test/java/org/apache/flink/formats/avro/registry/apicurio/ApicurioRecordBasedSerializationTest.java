...
class ApicurioRecordBasedSerializationTest {
    ...
    public void testCustomSerialization(TestSpec testSpec) {
        ApicurioRecordBasedSerializationFactoryImpl apicurioRecordBasedSerializationFactory =
                new ApicurioRecordBasedSerializationFactoryImpl();
        ...
        try {
            ApicurioSchemaRegistryCoder.augmentOutputStream(
                    out,
                    testSpec.useHeaders,
                    testSpec.encoding,
                    testSpec.globalId,
            ...
            ByteArrayOutputStream expectedPayloadStream =
                    new ByteArrayOutputStream(1 + 8 + payload.length);
            ...
            assertThat(recordBasedSerialization.getPayload(customSerialisation))
                    .isEqualTo(expectedPayload);

            Headers headers =
                    testSpec.isKey
                            ? recordBasedSerialization.getKeyHeaders(customSerialisation)
        ...
        return ImmutableList.of(
                ...
                new ValidTestSpec(
                        ...
                        ofEntries(
                                ...
                                new Object[] {
                                    IoUtil.toBytes(AvroEncoding.BINARY.name()),
                ...
                new ValidTestSpec(
                        ...
                        ofEntries(
                                ...
                                new Object[] {
                                    IoUtil.toBytes(AvroEncoding.JSON.name()),
                                    ApicurioSchemaRegistryCoder.longToBytes(13L),
                                    ApicurioSchemaRegistryCoder.longToBytes(12L)
                                })),
                // key json useHeader
