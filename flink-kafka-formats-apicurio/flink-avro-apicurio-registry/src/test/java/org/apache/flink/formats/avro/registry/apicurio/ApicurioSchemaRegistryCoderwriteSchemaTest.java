...
public class ApicurioSchemaRegistryCoderwriteSchemaTest {
    ...
    public void writeSchema(TestSpec testSpec) {
        try {
            ...
            assertThat(dataInputStream.readByte()).isEqualTo(ApicurioRegistryAvroFormatFactory.SUPPORTED_VERSION);
            int formatNameLength = dataInputStream.readInt();
            assertThat(formatNameLength).isEqualTo(ApicurioRegistryAvroFormatFactory.FORMAT_NAME_BYTE_ARRAY_LENGTH);
            ...
            assertThat(formatNameByteArray).isEqualTo(ApicurioRegistryAvroFormatFactory.FORMAT_NAME_BYTE_ARRAY);
    ...
    private static ImmutableList<TestSpec> getValidTestSpecs() {
        return ImmutableList.of(
                ...
                new ValidTestSpec(
                        true,
                        ofEntries(new String[] {REGISTERED_ARTIFACT_ID.key()},
                ...
                new ValidTestSpec(
                        true,
                        ofEntries(new String[] {USE_HEADERS.key(), REGISTERED_ARTIFACT_ID.key()},
