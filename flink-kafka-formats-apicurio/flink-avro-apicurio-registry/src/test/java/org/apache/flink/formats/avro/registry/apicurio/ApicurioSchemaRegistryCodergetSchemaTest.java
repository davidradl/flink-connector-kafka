...
public class ApicurioSchemaRegistryCodergetSchemaTest {
    ...
    public void getSchemaId(TestSpec testSpec) {
        try {
            ...
            ApicurioRecordBasedDeserialization recordBasedPayloadDeserialization =
                    (ApicurioRecordBasedDeserialization)
                            new ApicurioRecordBasedDeserializationFactoryImpl().create();
            ...
            if (testSpec.isKey) {
                deserCustomSerialization =
                        recordBasedPayloadDeserialization.getSerializedKeyFromConsumerRecord(
                                record);
            } else {
                deserCustomSerialization =
                        recordBasedPayloadDeserialization.getSerializedValueFromConsumerRecord(
                                record);
            }
    ...
    private static ImmutableList<TestSpec> getValidTestSpecs() {
        return ImmutableList.of(
                ...
                new ValidTestSpec(
                        true,
                        ofEntries(
                                new String[] {SerdeHeaders.HEADER_KEY_GLOBAL_ID},
                ...
                new ValidTestSpec(
                        ...
                        ofEntries(
                                ...
                                new Object[] {
                                    ApicurioSchemaRegistryCoder.longToBytes(12),
                                    ApicurioSchemaRegistryCoder.longToBytes(13)
                                }),
                        null,
                        null,
                        13L),
                ...
                new ValidTestSpec(
                        false,
                        ofEntries(
                                new String[] {SerdeHeaders.HEADER_VALUE_GLOBAL_ID},
                                new Object[] {ApicurioSchemaRegistryCoder.longToBytes(12)}),
                        null,
                        null,
                        12L),
                ...
                new ValidTestSpec(
                        true,
                        ofEntries(
                                new String[] {SerdeHeaders.HEADER_KEY_CONTENT_ID},
                                new Object[] {ApicurioSchemaRegistryCoder.longToBytes(12)}),
                        null,
                        null,
                        12L),
                ...
                new ValidTestSpec(
                        false,
                        ofEntries(
                                new String[] {SerdeHeaders.HEADER_VALUE_CONTENT_ID},
                                new Object[] {ApicurioSchemaRegistryCoder.longToBytes(12)}),
                        null,
                        null,
                        12L),
        ...
        return ImmutableList.of(
                ...
                new InvalidTestSpec(
                        ...
                        ofEntries(
                                ...
                                new Object[] {
                                    AvroEncoding.BINARY.name().getBytes()
