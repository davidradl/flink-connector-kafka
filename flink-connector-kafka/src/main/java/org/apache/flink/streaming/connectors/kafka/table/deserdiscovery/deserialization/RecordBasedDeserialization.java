...
public interface RecordBasedDeserialization {
 byte[] getSerializedKeyFromConsumerRecord(ConsumerRecord<byte[], byte[]> record) throws IOException;

 byte[] getSerializedValueFromConsumerRecord(ConsumerRecord<byte[], byte[]> record) throws IOException;
